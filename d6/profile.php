<?php
    ...
    if(isset($_SESSION['user_type']) && isset($_SESSION['login_type'])){
        ...
        if($_SESSION['login_type'] == 'facebook'){
            ...
            $table = "g_schools";
          }else if($_SESSION['login_type'] == 'normal'){
            $table = "schools";
          }
    }
                  ...
                  <div id="initialization" class="section scrollspy move-right">
                    ...
                    <?php for($i=0; $i < $package_counter; $i++){ ?>
                        <form action="payment/user_payment/request.php" method="post">
                            ...
                            <input type="hidden" name="name" value="sarang kartikey">
                            <input type="hidden" name="email" value="sarangkartikey50@gmail.com">
                            <input type="hidden" name="phone" value="8989797979">
                            <input type="hidden" name="purpose" value="cars">
